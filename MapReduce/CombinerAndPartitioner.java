...
public class CombinerAndPartitioner {
	...
	public static class MyPartitioner implements Partitioner<Text, IntWritable> {
		public int getPartition(Text key, IntWritable value, int numPartitions) {
			...
			if (myKey.equals("hadoop")) {//Hadoop and hadoop
				return 0;//first reducer or output file
			}
			if (myKey.equals("data")) {
				return 1;//2nd reducer
			} else {
				return 2;
			}
		}
	...
	public static void main(String[] args) throws Exception {
		...
		JobConf conf = new JobConf(CombinerAndPartitioner.class);
